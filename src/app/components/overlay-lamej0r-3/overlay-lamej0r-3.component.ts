...
<div class="overlay-wrapper" *ngIf="snapshot$ | async as data">
  ...
  styles: [`
    ...
    .glow-ring { position: absolute; inset: -4px; background: linear-gradient(to right, rgba(124, 58, 237, 0.3), rgba(167, 139, 250, 0.3), rgba(124, 58, 237, 0.3)); border-radius: 1.5rem; filter: blur(12px); animation: glowPulse 4s ease-in-out infinite; }
    ...
    .header { position: relative; padding: 1.125rem 1.5rem; background: linear-gradient(to right, rgba(124, 58, 237, 0.08), rgba(167, 139, 250, 0.08), rgba(124, 58, 237, 0.08)); }
    ...
    .challenge-text { font-size: 0.5rem; font-weight: 700; letter-spacing: 0.2em; color: #c4b5fd; text-transform: uppercase; white-space: nowrap; }
    ...
    .glass-card.primary { background: linear-gradient(135deg, rgba(124, 58, 237, 0.25) 0%, rgba(167, 139, 250, 0.18) 100%); border: 1.5px solid rgba(124, 58, 237, 0.5); box-shadow: 0 4px 20px rgba(124, 58, 237, 0.15); }
    ...
    .primary-value { color: #ddd6fe; text-shadow: 0 0 20px rgba(124, 58, 237, 0.5); }
    ...
    .corner-svg { position: absolute; width: 1rem; height: 1rem; color: rgba(124, 58, 237, 0.6); animation: cornerBreath 4s ease-in-out infinite; }
    @keyframes cornerBreath { 0%, 100% { color: rgba(124, 58, 237, 0.4); } 50% { color: rgba(124, 58, 237, 0.9); } }
...
export class OverlayLamej0r3Component implements OnInit {
