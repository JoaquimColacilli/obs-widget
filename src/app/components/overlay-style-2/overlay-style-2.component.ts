...
<div class="overlay-wrapper" *ngIf="snapshot$ | async as data">
  ...
  styles: [`
    ...
    .header { display: flex; flex-direction: column; gap: 0.25rem; padding: 0.5rem 0.75rem; background: linear-gradient(to right, rgba(236, 72, 153, 0.2), rgba(168, 85, 247, 0.2)); border-radius: 0.5rem; border: 1px solid rgba(236, 72, 153, 0.3); }
    ...
    .challenge-text { font-size: 0.65rem; font-weight: 700; letter-spacing: 0.15em; color: #f9a8d4; text-transform: uppercase; }
    ...
    .stat-row.featured { background: linear-gradient(to right, rgba(236, 72, 153, 0.15), rgba(168, 85, 247, 0.15)); border: 1px solid rgba(236, 72, 153, 0.3); }
    .stat-left { display: flex; align-items: center; align-self: center; gap: 0.5rem; flex-shrink: 0; }
    ...
    .featured-icon { color: #f472b6; filter: drop-shadow(0 0 6px rgba(236, 72, 153, 0.6)); }

    .stat-label {
      display: flex; align-items: center; height: 1rem; line-height: 1rem;
      font-size: 9px; color: #a1a1aa; text-transform: uppercase;
      letter-spacing: 0.03em; margin-top: 0; transform: translateY(-1px);
    ...
    .stat-totals { 
      font-size: 0.5rem; color: #e4e4e7; font-weight: 500; 
    ...
    /* Rank Badge */
    .rank-badge {
      font-size: 6px; font-weight: 700; padding: 1px 3px;
      border-radius: 2px; margin-top: 2px;
      animation: rankBadgePulse 0.5s ease-out; white-space: nowrap;
    }
    ...
    .abs-toast {
      ...
      font-size: 8px; font-weight: 700; color: #f472b6;
...
export class OverlayStyle2Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    const overlayId = `yunara-2-${this.account}`;
