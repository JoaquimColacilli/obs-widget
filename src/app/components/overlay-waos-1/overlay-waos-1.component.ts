...
<div class="overlay-wrapper" *ngIf="snapshot$ | async as data">
        ...
        <div class="container-hud breathing-border">
          ...
          <div class="content-row">
            <div class="brand-mark">
              ...
              <span class="brand-text">WAOS #kmu</span>
            </div>
  ...
  `,
    ...
    .corner { position: absolute; width: 10px; height: 10px; border-color: rgba(20, 184, 166, 0.7); border-style: solid; animation: cornerBreath 4s ease-in-out infinite; }
    @keyframes cornerBreath { 0%, 100% { border-color: rgba(20, 184, 166, 0.5); } 50% { border-color: rgba(20, 184, 166, 0.9); } }
...
export class OverlayWaos1Component implements OnInit {
